...
for i_reps in xrange(n_reps):
    ...
    for i_wind in xrange(n_windows):
        ...
        x_true_array_cm[i_reps, i_wind] = x_start_cm + i_wind * x_step_cm
        y_true_array_cm[i_reps, i_wind] = y_start_cm + i_wind * y_step_cm
...
savefig('figs/plot_sim_sequence_sigma_code_'+str(int(sigma_code_cm))+'_'+str(n_reps)+'reps_'+str(int(n_mincells))+'mincells_'+str(n_windows)+'steps.png', dpi=300)

print "saving plot data..."
file_save = open('data/sim_sequence_sigma_code_'+str(int(sigma_code_cm))+'_'+str(n_reps)+'reps_'+str(int(n_mincells))+'mincells_'+str(n_windows)+'steps.txt','w')
